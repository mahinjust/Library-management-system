...
<html>
  ...
  " >
				...
				<h1 style="text-align: center; font-size:20px;"><b>USER REGISTRATION FORM</b></h1>
				<form action="" name="User Registration" method="post">
					<div class="registration" style="padding-left: 100px;">
						<input class="Form-control" type="text" name="FULLNAME" placeholder="FULL NAME" required=""><br><br>
						...
						<input class="Form-control" type="text" name="ROLLNO" placeholder="ROLL NO" required=""><br><br>
