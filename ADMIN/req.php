...
<br>
<div class="container">
	<h3 style="text-align: center;"><b>BOOK APPROVAL</b></h3>
	<div class="srch">
	...
	<div style="margin-left: 340px;">
				<form class="navbar-form" method="post" name="form1">
					...
					<button style="background-color:#87CEFA;"type="submit" name="submit1" class="btn btn-info">DELETE
...
if(isset($_SESSION['login_user']))
{
	$sql="SELECT student.USERNAME,books.Bid,Name,Author,Edition,Status FROM student INNER JOIN issue_book ON student.USERNAME=issue_book.Username INNER JOIN books ON issue_book.Bid=books.Bid WHERE issue_book.Approve=''";
	...
	else
	{
		echo "Please Login First To See The Request Information.";
				...
				if (isset($_POST['submit1']))
			{
				if (isset($_SESSION['login_user']))
				{
					mysqli_query($db,"DELETE from issue_book where Bid='$_POST[Bid]';");
					?>
										<script type="text/javascript">
					(function (){
