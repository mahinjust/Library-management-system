...
<div class="container">
	<h3 style="text-align: center;"><b>CHANGE YOUR PROFILE PICTURE</b></h3>
		...
		$sql = "SELECT PICTURE FROM admins WHERE USERNAME='$_SESSION[login_user]'";
	...
	<br>
	<h4 style="text-align: center;"><b>YOU HAVE TO LOGOUT TO SEE YOUR NEW PROFILE PICTURE!!</b></h4>
</div>
<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE admins SET PICTURE='$PICTURE' WHERE USERNAME='".$_SESSION['login_user']."';";
