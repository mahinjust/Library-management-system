...
<div class="container">
	...
	$c=0;
		if (isset($_SESSION['login_user'])) 
		{
			$sql="SELECT student.USERNAME,books.Bid,Name,Author,Edition,Issue,issue_book.Return FROM student INNER JOIN issue_book ON student.USERNAME=issue_book.Username INNER JOIN books ON issue_book.Bid=books.Bid WHERE issue_book.Approve='YES' ORDER BY `issue_book`.`Return` ASC";
		...
		{
			?>
				<h3 style="text-align: center;"><b> LOGIN TO SEE THE INFORMATION OF BORROWED BOOKS</b></h3>
			<?php
		}
