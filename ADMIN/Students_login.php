	...
	<body>
		...
		<section>
			...
			<div class="box-2">
				...
				<h1 style="text-align: center; font-size: 20px;"><b>ADMIN LOGIN </b></h1>
				...
				<p style="padding-left: 55px;">
					...
					<a href="update.php" style="color:black;"><b>FORGOT PASSWORD!</b></a> <b>&nbsp
					NEW TO THIS SITE?</b>
					<a href="signup.php" style="color:black;"><b>SIGN UP</b></a>
				</p>
			</div>
		</section>
